...
2. Get your [Google Places API keys](https://developers.google.com/maps/documentation/places/web-service) and enable "Google Places API Web Service" (NOT Android or iOS) in the console.
